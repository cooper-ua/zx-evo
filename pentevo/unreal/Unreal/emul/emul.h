...
constexpr int PAGE = 0x4000U;
constexpr int MAX_RAM_PAGES = 256; // 4Mb RAM
constexpr int MAX_CACHE_PAGES = 2; // 32K cache
constexpr int MAX_MISC_PAGES = 1;  // trash page
constexpr int MAX_ROM_PAGES = 64;  // 1Mb
...
constexpr int MAX_PAGES = (MAX_RAM_PAGES + MAX_CACHE_PAGES + MAX_MISC_PAGES + MAX_ROM_PAGES + MAX_GSROM_PAGES + MAX_GSRAM_PAGES);
